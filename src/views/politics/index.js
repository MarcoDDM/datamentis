  ...
  render() {
    return (
      <div className="container-politics">
        ...
        información específica para procesar algún pedido o realizar una entrega o facturación. <br />
        <br />
        ...
        declinar las cookies. Si se declinan es posible que no pueda utilizar algunos de nuestros servicios. <br />
        <br />
        ...
        consulte para confirmar que usted está de acuerdo con estas. <br />
        <br />
